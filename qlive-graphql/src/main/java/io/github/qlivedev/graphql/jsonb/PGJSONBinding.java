    ...
    implements Binding<org.jooq.JSONB, JSONB>
{
    ...
    public Converter<org.jooq.JSONB, JSONB> converter()
    {
        return new Converter<org.jooq.JSONB, JSONB>()
        {
            ...
            {
                // a nullable json column is null often enough, and a converter is handed that null
                return t == null ? null : JSONB.forValue(t.data());
            }
            ...
            {
                return u == null ? null : org.jooq.JSONB.valueOf(u.toJSON());
            }
