...
import static io.github.qlivedev.runtime.scalar.FilterDSL.not;
import static io.github.qlivedev.runtime.scalar.FilterDSL.or;
...
class FilterTransformerTest
{
    ...
    private static io.github.qlivedev.model.condition.Value big(BigInteger value)
    {
