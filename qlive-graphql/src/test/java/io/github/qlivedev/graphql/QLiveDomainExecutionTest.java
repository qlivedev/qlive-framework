...
public class QLiveDomainExecutionTest
{
    ...
    public void testGenericDomainObject()
    {
        ...
        GraphQL graphQL = GraphQL.newGraphQL(schema).build();
        {
            ...
            assertThat(
                data,
                is("{\"_javaType\":\"io.github.qlivedev.graphql.testdomain.tables.pojos.Foo\",\"created\":\"=2018-10-15 14:03:58.078 (Timestamp)\",\"id\":\"=e7c103e7-f559-4896-ac44-702b8458f207 (String)\",\"name\":\"=GreenFoo (String)\",\"num\":\"=9384 (Integer)\"}")
            );
        }
