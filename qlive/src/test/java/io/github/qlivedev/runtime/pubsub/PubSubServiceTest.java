...
class PubSubServiceTest
{
        ...
        implements Recipient
    {
        ...
        List<String> topics()
        {
            return received.stream().map(io.github.qlivedev.model.push.Topic::getTopic).toList();
        }


        List<List<String>> ids()
        {
            return received.stream().map(io.github.qlivedev.model.push.Topic::getIds).toList();
        }


        List<Object> payloads()
        {
            return received.stream().map(io.github.qlivedev.model.push.Topic::getPayload).toList();
        }
    }
