...
public class AppVersion extends GeneratedDomainObject implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.fieldLayout == null) {
            if (other.fieldLayout != null)
                return false;
        }
        else if (!this.fieldLayout.equals(other.fieldLayout))
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((this.fieldLayout == null) ? 0 : this.fieldLayout.hashCode());
        return result;
    }
