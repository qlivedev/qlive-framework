...
///
/// A peer of {@link io.github.qlivedev.runtime.query.condition.ConditionTransformer}, not a variant of
...
public class FilterTransformer
{
    ...
    private Predicate<Object> logic(io.github.qlivedev.model.condition.Condition node)
    {
    ...
    private Predicate<Object> comparison(io.github.qlivedev.model.condition.Condition node)
    {
        final String name = node.getName();
