...
import static io.github.qlivedev.runtime.scalar.FilterDSL.component;
...
class ConditionTransformerTest
{
    ...
    private static io.github.qlivedev.model.condition.Condition condition(String name, CNode... operands)
    {
        final io.github.qlivedev.model.condition.Condition condition =
            new io.github.qlivedev.model.condition.Condition();
