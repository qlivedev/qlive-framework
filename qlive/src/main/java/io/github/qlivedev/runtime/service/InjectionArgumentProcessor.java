...
/// {@link io.github.qlivedev.runtime.util.Util#isQueryDocumentType(io.github.qlivedev.graphql.QLiveDomain, String)}
...
public interface InjectionArgumentProcessor
{
    ...
    ///
    /// @throws io.github.qlivedev.runtime.QLiveException  when the value cannot be one, via
